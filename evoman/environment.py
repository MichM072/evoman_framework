...
class Environment(object):
    ...
    def __init__(
        ...
        enemies=[4],  # array with 1 to 8 items, values from 1 to 8
        ...
        self.enemyImports = {
            e: __import__("evoman.enemy" + str(e), fromlist=["enemy" + str(e)])
    ...
    def load_sprites(self):
        ...
        if not self.enemyn in self.enemyImports:
            self.enemyImports[self.enemyn] = __import__(
                "evoman.enemy" + str(self.enemyn), fromlist=["enemy" + str(self.enemyn)]
            )
        ...
        self.enemy = enemy.Enemy(
            (start_cell.px, start_cell.py), self.sprite_e, visuals=self.visuals
        )
    ...
    def run_single(self, enemyn, pcont, econt):
        ...
        while 1:
            ...
            if self.visuals:
                ...
                pygame.draw.line(
                    self.screen, (150, 24, 25), [40, 45], [140 - vbar, 45], 5
                )
